...
| **Mobile** | 🟡 En cours — Viewport, safe area, barre pause (wrap, 1x–3x), upgrades (scroll), Custom responsive, cibles 44px, overscroll/pull-to-refresh. Reste : overlays, typo, Replay, optionnel PWA. | [ROADMAP_V5_MOBILE.md](./ROADMAP_V5_MOBILE.md) |
