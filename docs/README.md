...
| **Mobile** | 🟡 En cours — Viewport, safe area, zoom désactivé sur /play, barre pause, upgrades (scroll), Custom responsive, cibles 44px, overlays, typo clamp(), PWA (manifest, icône, SW). Jeu en portrait et paysage. Reste : Replay (tailles tap). | [ROADMAP_V5_MOBILE.md](./ROADMAP_V5_MOBILE.md) |
